...
from trackers import depthmot_tracker as tracker_module
...
def get_main_args():
    ...
    if args.dataset == "mot17":
        ...
        args.result_folder = os.path.join(args.result_folder, "SPORT-val")
...
def main():
    ...
    for (img, np_img), label, info, idx, img_path in loader:
        # Frame info
        ...
        targets = tracker.update(pred, img, np_img[0].numpy(), tag, img_path)
    ...
    folder = os.path.join(args.result_folder, args.exp_name, "data_raw")
